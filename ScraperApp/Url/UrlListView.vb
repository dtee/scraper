   ...
   Public Sub New()
      ...
      For Each col As DataColumn In dt.Columns
         ...
         If col Is dt.UrlStatusIDColumn Then
            ...
            StatuCol = c
            c.HeaderText = "Status"
            c.DataSource = ScraperLib.UrlManager.UrlStatusDT
            c.DisplayMember = ScraperLib.UrlManager.UrlStatusDT.NameColumn.ColumnName
            c.ValueMember = ScraperLib.UrlManager.UrlStatusDT.UrlStatusIDColumn.ColumnName
      ...
      For Each row As ScraperDB.UrlStatusRow In ScraperLib.UrlManager.UrlStatusDT.Rows
...
#Region "Contorl Functions"
   ...
   Private _UrlList As UrlManager
...
#End Region
   ...
   Private Sub UrlListView_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing

Public Class WizardCtl
   ...
   Public Property DirName() As String
      ...
      Set(ByVal value As String)
         ...
         If value IsNot Nothing Then
            ...
            _Dt.ReadXmlSchema(_DirName & "\" & Me.ContorlName & ".xml.schme")
            _Dt.ReadXml(_DirName & "\" & Me.ContorlName & ".xml")

            Me.RichTextBox1.Text = System.IO.File.ReadAllText(_DirName & "\" & Me.ContorlName & ".html")
   ...
   Public Property TagTree() As TagTree
      ...
      Set(ByVal value As TagTree)
         Me._TagTree = value
         Me.TagTreeView1.TagTree = _TagTree
      End Set
   End Property

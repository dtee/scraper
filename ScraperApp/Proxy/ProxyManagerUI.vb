...
Public Class ProxyManagerUI
   ...
   Public Property ProxyManager() As ProxyManager
      ...
      Set(ByVal value As ProxyManager)
         ...
         If value IsNot Nothing Then
            Me.DataGridView1.DataSource = value.ProxyDT
   ...
   Public Sub New()
      ...
      Me.ProxyManager = New ProxyManager(New ScraperDB.ProxyDataTable)

      ' Add sample proxy to test
      Me._ProxyManager.AddProxy("220.233.179.159", 80)
      Me._ProxyManager.AddProxy("216.197.181.197", 80)
      Me._ProxyManager.AddProxy("69.193.226.114", 80)
   End Sub
...
#End Region
   ...
   Private Sub DataGridView1_RowsRemoved(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewRowsRemovedEventArgs) Handles DataGridView1.RowsRemoved
      ...
      Me.StatusToolStripStatusLabel.Text = String.Format("{0}/{1} (Work/Total)", Me._ProxyManager.ProxyToUseCount, Me._ProxyManager.TotalProxy)
   End Sub

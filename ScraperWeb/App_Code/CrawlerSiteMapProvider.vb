...
Namespace Samples.AspNet.VB.Controls
   ...
   Public Class CrawlerSiteMapProvider
      ...
      Private AccessConnectionStringName As String = "ScraperDBConnectionString"
      ...
      Public Overrides Function BuildSiteMap() As SiteMapNode
         ...
         SyncLock Me
            ...
            If aRootNode Is Nothing Then
               ...
               Clear()
               aRootNode = New SiteMapNode(Me, "Key", "Home", "Display")
